...
<IntroScreen>:
    ...
    BoxLayout:
        ...
        GridLayout:
            ...
            IndexButton:
                text:"[color=cd0000][i]GLOBAL[/i][/color]"
                on_release: webbrowser.open('https://www.worldometers.info/coronavirus/')
            IndexButton:
                text:"[color=cd0000][i]ITALY[/i][/color]"
                on_release: webbrowser.open('https://lab.gedidigital.it/gedi-visual/2020/coronavirus-in-italia/')
            IndexButton:
            ...
            IndexButton:
                text:"[color=27408b][i]WORLD MAP[/i][/color]"
                on_release: webbrowser.open('https://www.healthmap.org/covid-19/')
            IndexButton:
                text:"[color=27408b][i]THINGS TO DO[/i][/color]"
                on_release: webbrowser.open('https://www.cdc.gov/coronavirus/2019-ncov/about/prevention.html')
            IndexButton:
